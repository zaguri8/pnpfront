...
export const transactionConfirmationFromDict: (snap: DataSnapshot) => PNPTransactionConfirmation = (snap) => {
    return {
        ...
        lastScanDate: snap.child('lastScanDate').val(),
        customerEmail: snap.child('customerEmail').val(),
        customerName: snap.child('customerName').val(),
        customerPhone: snap.child('customerPhone').val(),
        destination: snap.child('destination').val(),
        startPoint: snap.child('startPoint').val(),
        amount: snap.child('amount').val(),
