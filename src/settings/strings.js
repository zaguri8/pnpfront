...
export const OPEN_FAVORITE_EVENTS_DIALOG = (lang) => lang === 'heb' ? 'לחץ/י על מנת לבחור' : 'Click to pick'
...
export const TERMS_OF_USE = (lang) => lang === 'heb' ? 'אני מאשר שקראתי את התקנון ומסכים לתנאי השימוש' : 'I agree to the terms of use and accept them'
...
export const CARD_NUMBER = (lang) => lang === 'heb' ? 'מספר כרטיס' : 'Card number'
export const EXPIRATION = (lang) => lang === 'heb' ? 'תוקף' : 'Expiration'
export const EXP_M = (lang) => lang === 'heb' ? 'חודש' : 'Month'
